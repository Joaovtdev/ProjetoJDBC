...
public class Main {
    ...
    public static void atualizarVenda(Scanner scanner){
        try{
            Connection conn = connection();
            System.out.println("DIgite o código de venda para atulizar:");
            ...
            PreparedStatement preparedStatement = conn.prepareStatement(
                    "UPDATE venda SET cliente = ? WHERE id_venda = ?");
            ...
            System.out.println("Erro ao alterar a venda.");
            e.printStackTrace();
        }
    }
